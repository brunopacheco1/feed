...
@Stateless
public class NormalizedDocumentsToPersistQueueService extends AbstractService {
	
	@Resource(mappedName = "java:/ConnectionFactory")
    private ConnectionFactory connectionFactory;
 
	@Resource(name="normalizedDocumentQueue")
	private String normalizedDocumentQueue;
	
	@Inject
	private NormalizedDocumentsToPersistQueueControllerService executionService;
    ...
    public void init() {
        try {
            ...
            Destination destination = (Destination) ctx.lookup(normalizedDocumentQueue);
	...
	public void finish(Long robotId) {
    	if (executionService.hasNormalizedDocumentsToPersist()) {
			return;
		}
